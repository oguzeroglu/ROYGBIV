...
var keyboardInfo = [
  ...
  "A/D : Translates the camera along X axis.",
  "Up/Down : Rotates the camera around X axis.",
  "Left/Right : Rotates the camera around Y axis.",
  "E/Q : Translates the camera upon Y axis.",
  "Z/C: Rotates the camera around Z axis.",
  "T/Y: Texture offset adjustment. (X)",
  "G/H: Texture offset adjustment. (Y)",
  "O/P: Object opacity adjustment.",
  "Backspace: Destroys selected object.",
  "V/B: Light intensity adjustment.",
  "N/M: Object shininess adjustment.",
  "K/L: Height map scale adjustment.",
  "U/I: Height map bias adjustment.",
...
var MAX_PARTICLE_SYSTEM_COUNT = 1000;
