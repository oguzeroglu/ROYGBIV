...
CPUOperationsHandler.prototype.updateDOMElementPositionAlignments = function(){
  if (this.record){
    var s = performance.now();
    updateDOMElementPositionAlignments();
    this.performanceLogs.domElementPositionAlignment = performance.now() - s;
  }else{
    updateDOMElementPositionAlignments();
  }
}
