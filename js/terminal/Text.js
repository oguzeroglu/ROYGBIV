var Text = function(){
  ...
  this.ROYGBIV_SCRIPTING_API_HEIGHTMAPSCALE = "Modifies the height map scale of an object.";
  this.ROYGBIV_SCRIPTING_API_GETHEIGHTMAPSCALE = "Returns the height map scale of an object.";
  this.ROYGBIV_SCRIPTING_API_HEIGHTMAPBIAS = "Modifies the height map bias of an object.";
  this.ROYGBIV_SCRIPTING_API_GETHEIGHTMAPBIAS = "Returns the height map bias of an object.";
