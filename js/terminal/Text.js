var Text = function(){
  ...
  this.CREATED_X_SURFACES = "Created @@1 surfaces.";
  this.CREATED_X_BOXES = "Created @@1 boxes.";
  this.CREATED_X_SPHERES = "Created @@1 spheres.";
  ...
  this.ROYGBIV_SCRIPTING_API_GETSHININESS = "Returns the shininess of an object. Only the objects that have Phong materials have shininess property.";
