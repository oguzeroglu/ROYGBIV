var Text = function(){
  ...
  this.FOG_SET = "Fog set. Fogs are visible only in preview mode.";
  ...
  this.ROYGBIV_SCRIPTING_API_SETCOLLISIONLISTENER = "Sets a collision listener for an object, glued object, particle or a particle system. Using this with loads of particles\nmay cause performance issues if web worker usage is not enabled or supported. Callback function given as the second parameter is fired\nwith a CollisionInfo instance when the sourceObject is collided with other objects or glued objects of the scene." +
                                                    " The additional\ntimeOffset parameter can be used for particles/particle systems to pre-calculate future collisions. This can help to prevent visual\nerrors of collisions of rather fast particles/particle systems.";
