...
function WebGLRenderer( parameters ) {
	...
	this.renderBufferDirect = function ( camera, fog, geometry, material, object, group ) {
		...
		var geometryProgram_GID = geometry.id;
		var geometryProgram_PID = program.id;
		var geometryProgram_WIREFRAME = ( material.wireframe === true );

		var updateBuffers = false;

		// OGUZ
		if ( geometryProgram_GID != _currentGeometryProgram_GID ||
		 				geometryProgram_PID != _currentGeometryProgram_PID ||
								geometryProgram_WIREFRAME != _currentGeometryProgram_WIREFRAME) {

			_currentGeometryProgram_GID = geometryProgram_GID;
			_currentGeometryProgram_PID = geometryProgram_PID;
			_currentGeometryProgram_WIREFRAME = geometryProgram_WIREFRAME;
			updateBuffers = true;
	...
	*/
	...
	function refreshUniformsCommon( uniforms, material ) {
		...
		if ( material.map ) {
			...
			uvScaleMap = material.displacementMap; // OGUZ
